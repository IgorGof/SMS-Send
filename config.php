<?php
	define("HTTPS_LOGIN", "utszn"); //Ваш логин для HTTPS-протокола
	define("HTTPS_PASSWORD", "7b7cd030ef"); //Ваш пароль для HTTPS-протокола
	define("HTTPS_ADDRESS", "https://lcab.smsprofi.ru/"); //HTTPS-Адрес, к которому будут обращаться скрипты. Со слэшем на конце.
